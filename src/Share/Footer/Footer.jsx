                ...
                <div className="mt-10 lg:grid lg:grid-cols-9 gap-9">
                    ...
                    <div className="mb-8 lg:col-span-2">
                        ...
                        <div className="flex items-center gap-2 text-lg">
                            ...
                            <h2 className="text-[#888] items-center flex">khoj@gmail.com</h2>
                        </div>
                        <div className="flex items-center gap-2 text-lg mt-5">
                            <MdOutlineMailOutline className="text-[#b19777] text-lg"></MdOutlineMailOutline>
                            <h2 className="text-[#888] items-center flex">kajerkhoj@gmail.com</h2>
                        </div>
                    </div>
                    <div className="mb-8 lg:col-span-2">
            ...
            <div>
                <div>
                    ...
                    <div className="lg:flex justify-center gap-1 p-6">
                        <p className="flex items-center gap-1 text-[#bece8861] justify-center">Copyright <MdOutlineCopyright></MdOutlineCopyright> 2024 Kajer Khoj.</p>
